...
//    } else {
//       select_type_content =
//          '<div class="select__value"><span>' + select_selected_text + '</span></div>';
//    }
//
//    select_parent.insertAdjacentHTML(
//       'beforeend',
...
export const customStyles = {
   option: (provided, state) => {
      return {
         ...
         backgroundColor: state.isSelected ? '#e9856b' : null,
         padding: '5px',
         cursor: 'pointer',
         ':hover': {
            backgroundColor: state.isSelected ? '#e9856b' : '#f7f7f7',
            color: state.isSelected ? 'null' : '#000'
         },
      }
   },
   ...
   control: (provided, state) => {
      return {
         maxWidth: 690,
         display: 'flex',
         borderBottom: state.hasValue ?  '1px solid #e9856b' : '1px solid #9EA4AB',
      }
   },
}

export const activityCustomStyles = {
   option: (provided, state) => {
      return {
         ...provided,
         color: state.isSelected ? '#fff' : null,

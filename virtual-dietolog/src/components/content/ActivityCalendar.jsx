...
function ActivityCalendar({canEventChange,changeDialog, setDates, changeInfoSelectDates, editEvent}) {
   const ref = useRef();
   ...
   const renderEventContent = eventInfo => {
      ...
      return (
         <>
            <div onMouseEnter={({target}) => {target.style.backgroundColor = hexColor + '45'}}
                 onMouseOut={({target}) => {target.style.backgroundColor = hexColor + '25'}}
...
export default observer(ActivityCalendar);